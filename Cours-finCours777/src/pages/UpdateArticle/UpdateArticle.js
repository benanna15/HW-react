    ...
    const handleSubmit = (e) => {
        ...
        axios.get('https://crud-webschool-32dd1a.appdrag.site/api/testToken', {
            ...
            if (response.data.Table.length > 0) {
                axios.get('https://crud-webschool-32dd1a.appdrag.site/api/updateArticlesPrep', {
                    params: {
                        title: form.title,
                        auteur: form.auteur,
                    ...
                    SetError(false)
                    setForm({ title: "", article: "", auteur: "",  id: "" })
                });
            } else {
                SetError(true)
        ...
        <div>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div>
                    ...
                    <input type="text" id="auteur"  value={form.auteur} onChange={(e) => setForm((prevState) => ({ ...prevState, auteur: e.target.value }))} />
                </div>
                <div>
