...
const RandomUsers = () => {
  ...
  useEffect(() => {
    // Utilisez un appel Axios pour récupérer la liste des utilisateurs
    axios.get('https://promises-cb263f.appdrag.site/api/getAllUsers', {
      params: {
        ...
        // Obtenez les 8 premiers utilisateurs
        const selectedUsers = shuffledUsers.slice(0, 5);
        // Mettez à jour l'état local avec les utilisateurs sélectionnés
