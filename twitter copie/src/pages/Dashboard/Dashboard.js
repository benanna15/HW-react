...
const Dashboard = () => {
  ...
  // Utilisez useSelector pour extraire les données du magasin Redux
  ...
  const handleHomeClick = () => {
    // Mettre à jour l'état pour forcer la mise à jour du composant Home
  ...
  }, [isAuthenticated, navigate]); // Les dépendances sont importantes ici

  // Si l'utilisateur n'est pas connecté, ne retournez rien
  if (!isAuthenticated) {
    return null;
  }
  ...
  return (
    <div className="flex">
      ...
      <div className="w-1/2 m-10">
        {/* Passez directement les données extraites du magasin Redux à Home */}
