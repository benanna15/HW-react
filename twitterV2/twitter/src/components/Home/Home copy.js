...
// maj de likes apres comment
    const updateLikeInHome = () => {
      // Mettez à jour le nombre total de likes pour le tweet spécifié
      // dans votre état ou gestionnaire d'état global (Redux).
      // ...
  
      // Assurez-vous que le composant Home est informé du changement
      // en mettant à jour l'état local, par exemple.
      fetchData()
    };
  //lire les tweets
