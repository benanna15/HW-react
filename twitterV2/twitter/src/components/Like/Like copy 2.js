...
const Like = (props) => {
  const { tweet, id ,likes, likeCount, redHeart,  findLike, updateTotalLikesInHome } = props;
  ...
  //   }
  // }, [dispatch,id,tweet.id,likeCount]);
  ...
  const handleLikeClick = async () => {
    ...
    try {
      if (findLike) {
        ...
        updateTotalLikesInHome(updatedLikeCount, newLikeValue);
